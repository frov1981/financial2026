...
```text
FILE: C:\Users\Dell\Documents\Proyectos\ssrfinan\src\entities\Loan.entity.ts
```
...
```text
FILE: C:\Users\Dell\Documents\Proyectos\ssrfinan\src\entities\LoanGroup.entity.ts
```
...
```text
FILE: C:\Users\Dell\Documents\Proyectos\ssrfinan\src\entities\LoanPayment.entity.ts
```
